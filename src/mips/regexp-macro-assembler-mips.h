...
// TODO : return correct register. end of modified lines indicated with _-_-_-_-_-_-_-_-_-_-_-_-_-_-
  
  // Register holding the current input position as negative offset from
  // the end of the string.
//  inline Register current_input_offset() { return r6; }
  inline Register current_input_offset() { return no_reg; }

  // The register containing the current character after LoadCurrentCharacter.
//  inline Register current_character() { return r7; }
  inline Register current_character() { return no_reg; }

  // Register holding address of the end of the input string.
//  inline Register end_of_input_address() { return r10; }
  inline Register end_of_input_address() { return no_reg; }

  // Register holding the frame address. Local variables, parameters and
  // regexp registers are addressed relative to this.
//  inline Register frame_pointer() { return fp; }
  inline Register frame_pointer() { return no_reg; }

  // The register containing the backtrack stack top. Provides a meaningful
  // name to the register.
//  inline Register backtrack_stackpointer() { return r8; }
  inline Register backtrack_stackpointer() { return no_reg; }

  // Register holding pointer to the current code object.
//  inline Register code_pointer() { return r5; }
  inline Register code_pointer() { return no_reg; }
...
//_-_-_-_-_-_-_-_-_-_-_-_-_-_-
  ...
  inline void SafeCall(Label* to, Condition cond = cc_always);
